...
//? Arithmetic operators in programming perform basic mathematical operations on variables or values.
//? They include addition, subtraction, multiplication, division, and modulus.

//todo  Addition (+): Adds two values or variables.
//Example:-
// let x = 5;
// let y = 10;
// let sum = x + y;
...
//! Q: Let say you have a variable score representing a student's exam score. If the score is greater than or equal to 60,
//!  the student passes; otherwise, they fail. Use the conditional (ternary) operator to determine the result and store it in a variable
//! called result. Log the result to the console❓
