//!  Explanations :-
    ...
    //? 1. Number:- Represents numeric vlues, including integers and floating-point numbers.
    //Example
    var myFavNum = 45;
    ...
    //? 3. Boolean:- Represents a logical entity with wo values : true or false.
      //Example
      var isRaining = false;
      var areYouFriendly = true;
      console.log(isRaining);
      console.log(areYouFriendly);
    ...
    //? 4. undefined:- Represents the absence of a value or an uninitialized variable.
     ...
     var manish;
     console.log(manish);
    //? 5. Null:- Represents the absence of value. It is often used to explicitly indicate that a 
    //?           variable or object properly has no assigned value.
     ...
     //Example
     const bigNumber = 1234567890876532121345543466540n;
     ...
     //? 4. What is the primitive data types in JavaScript/

     //? 5. Convert a string into a nimber?
            // var myFavNum = "18";
            // console.log(typeof +myFavNum);
            // console.log(typeof Number(myFavNum));


    //? 6. Convert a number into a string?
    //*    We just to need to add an empty string after the number.
    // Example:-
